...
import { faHeartbeat, faEnvelope, faPhone } from "@fortawesome/free-solid-svg-icons"
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <FontAwesomeIcon icon={faHeartbeat} className="h-8 w-8 text-blue-400" />
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/your-username/diabeacheck"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">info@diabeacheck.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <FontAwesomeIcon icon={faPhone} className="h-4 w-4 text-blue-400" />
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">© 2024 DiabeaCheck. Dikembangkan oleh Tim CC25-CF186. Semua hak dilindungi.</p>
        </div>
      </div>
    </footer>
  )
